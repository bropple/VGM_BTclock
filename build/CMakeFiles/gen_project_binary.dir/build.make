...
.bin_timestamp: a2dp_sink.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/micro/github/VGM_BTclock/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating binary image from built executable"
	/home/micro/.espressif/python_env/idf4.0_py3.9_env/bin/python /home/micro/github/esp-idf-v4.0/components/esptool_py/esptool/esptool.py --chip esp32 elf2image --flash_mode dio --flash_freq 40m --flash_size 2MB --elf-sha256-offset 0xb0 -o /home/micro/github/VGM_BTclock/build/a2dp_sink.bin a2dp_sink.elf
	/usr/bin/cmake -E echo "Generated /home/micro/github/VGM_BTclock/build/a2dp_sink.bin"
	/usr/bin/cmake -E md5sum /home/micro/github/VGM_BTclock/build/a2dp_sink.bin > /home/micro/github/VGM_BTclock/build/.bin_timestamp
